...
const routeEnhancementsByLang: Partial<Record<Lang, RouteEnhancement>> = {
  ru: {
    quickFacts: [
      ...
      { label: "Где действует", value: "ЕЭЗ и Швейцария" },
    ...
    border: {
      ...
      items: [
        {
          title: "Полис нужен до начала движения по территории стран Европейской экономической зоны",
          text:
    ...
    scenarios: {
      ...
      items: [
        {
          title: "Например, Едете в Польшу на личном автомобиле",
          text:
