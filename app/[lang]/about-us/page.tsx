...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return createLocalizedMetadata({ lang: safeLang, pathname: '/about-us', title: dict.pages.about.title, description: dict.pages.about.intro });
}
...
export default async function AboutPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <ContentPageSection content={dict.pages.about} />;
}
