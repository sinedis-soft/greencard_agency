...
export const seoDictionary: Record<Lang, SeoDictionary> = {
  ru: {
    home: {
      ...
      description: "Трансграничная MTPL-страховка для международных перевозок: Green Card, border insurance, Зеленая карта в Евросоюз, OC graniczna.",
    },
    about: {
      title: "О нас — страховое агентство с лицензией",
      description: "Польское страховое агентство для путешествующих: оформление пограничного страхования в страны Европейской экономической зоны.",
    },
    contacts: {
      title: "Контакты — оформить border insurance",
      description: "Свяжитесь с агентом по пограничному страхованиию для путешествующих по маршрутам EU и non-EU.",
    },
    productInfo: {
      title: "Продукт и покрытие — Green Card / MTPL cross-border / OC graniczna",
    ...
    rules: {
      ...
      description: "Правила оформления и использования border insurance и Green Card для поездок через границы.",
    },
    privacy: {
  ...
  pl: {
        ...
        productInfo: {
            title: "Produkt i zakres ochrony — Zielona Karta / MTPL cross-border / OC graniczne",
            description:
  ...
  en: {
        ...
        productInfo: {
            title: "Product and Coverage — Green Card / Cross-Border MTPL / OC graniczna",
            description:
  ...
  ka: {
    home: {
        title: "Border insurance ტვირთგადამზიდავებისა და ფიზიკური პირებისთვის",
        description:
  ...
  kk: {
    home: {
        title: "Жүк тасымалдаушылар мен жеке тұлғаларға арналған border insurance",
        description:
  ...
  tr: {
    ...
    productInfo: {
        title: "Ürün ve teminat — Green Card / MTPL cross-border / OC graniczna",
        description:
  ...
  hy: {
    ...
    contacts: {
        title: "Կոնտակտներ — оформить border insurance",
        description:
