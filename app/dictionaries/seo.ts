...
export const seoDictionary: Record<Lang, SeoDictionaryBase> = {
  ...
  ar: {
    home: {
      title: "تأمين الحدود للسيارات الأجنبية في أوروبا | SINEDIS",
      description:
        "اطلب تأمين الحدود (OC Graniczne) لمركبة مسجّلة خارج المنطقة الاقتصادية الأوروبية. احسب التكلفة، وأرسل المستندات، واستلم وثيقة PDF بعد التحقق.",
    },

    about: {
      title: "من نحن | وكيل التأمين SINEDIS في بولندا",
      description:
        "تعرّف على وكيل التأمين البولندي المسجّل SINEDIS، واختصاصه في تأمين الحدود للمركبات الأجنبية وخدمات التأمين للرحلات الدولية.",
    },

    contacts: {
      title: "اتصل بنا | المساعدة في إصدار تأمين الحدود",
      description:
        "تواصل مع SINEDIS للاستفسار عن تأمين الحدود، ودول التغطية، والمستندات المطلوبة، وتكلفة الوثيقة وإمكانية إصدارها لمسار رحلتك.",
    },

    productInfo: {
      title: "تأمين الحدود: التغطية والشروط | OC Graniczne",
      description:
        "اطّلع على شروط تأمين الحدود، ونطاق التغطية، والدول المشمولة، ومبالغ الضمان والاستثناءات، والفرق بين OC Graniczne والبطاقة الخضراء.",
    },

    rules: {
      title: "شروط تقديم خدمة إصدار تأمين الحدود",
      description:
        "اقرأ شروط تقديم الطلب، ومراجعة المستندات، وتأكيد التكلفة، والدفع، وإصدار وثيقة تأمين الحدود وتسليمها إلى العميل.",
    },

    privacy: {
      title: "سياسة الخصوصية | Green Card Agency",
      description:
        "تعرّف على كيفية جمع البيانات الشخصية واستخدامها وحمايتها عند تقديم طلب تأمين الحدود والتواصل مع Green Card Agency.",
    },

    cookiePolicy: {
      title: "سياسة ملفات تعريف الارتباط | Green Card Agency",
      description:
        "معلومات عن ملفات تعريف الارتباط والأدوات التحليلية المستخدمة لتحسين أداء موقع Green Card Agency وقياس استخدام صفحاته.",
    },
  },
