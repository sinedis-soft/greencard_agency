...
const ru: BelarusPolandOcDictionary = {
  ...
  validity: { title: "Сроки действия", text: "Доступны полисы на срок от 30 до 364 дней. Дата начала указывается при оформлении, после чего покрытие действует выбранный период. Если при заполнении заявки вы не видите нужного вам срока - укажите эти данные в комментарии." },
  ...
  faq: { title: "FAQ", items: [
    ...
    { q: "Как быстро приходит полис?", a: "После подтверждения оплаты полис обычно отправляется в течение короткого времени в электронном виде. Зависит от загруженности операторов, в среднем в течение 10 минут." },
...
const kk: BelarusPolandOcDictionary = {
  seo: {
    title: "Беларусь көлігіне Польшаға бару үшін сақтандыру",
    description:
      "Польшаға бару үшін сақтандыру рәсімдеу. Онлайн-өтінім, құнын есептеу, WhatsApp және Telegram арқылы қолдау.",
  },
  breadcrumbTitle: "Беларусь көлігін Польшаға бару үшін сақтандыру",
  hero: {
    kicker: "Беларусьтен келген автокөліктерге арналған сақтандыру",
    title: "Беларусь нөмірлі автокөліктерге Польшаға бару үшін сақтандыру",
    lead:
      "Польшаға және ЕО елдеріне кіру әрі сапар жасау үшін полисті рәсімдеңіз: онлайн-өтінім, құнын есептеу және мессенджерлер арқылы сүйемелдеу.",
    cta: "Сақтандыруға өтінім беру",
  },
  what: {
    title:
      "Беларусь нөмірлі автокөлікке Польшаға бару үшін OC graniczne",
    text:
      "Егер автокөлік Беларусьте тіркелген болса және сіз Польшаға баруды жоспарласаңыз, елге кіру үшін OC graniczne шекаралық сақтандыру шарты қажет болуы мүмкін. Мұндай полис Еуропалық экономикалық аймақтан тыс жерде тіркелген және қолданыстағы «Жасыл картасы» жоқ көлік құралдарына рәсімделеді. Бұл беттен OC graniczne кімге қажет екенін, оны қалай рәсімдеуге болатынын, сақтандырудың қанша тұратынын және қандай мерзімге рәсімделетінін біле аласыз. Өтінім берілгеннен кейін полис PDF форматында жіберіледі.",
  },
  who: {
    title: "Бұл полис кімге қажет:",
    items: [
      "Беларусьте тіркелген автокөліктердің иелері мен жүргізушілеріне.",
      "Польшаға жеке автокөлікпен кіретін адамдарға.",
      "Үшінші тұлғалар алдындағы жауапкершілікті сақтандырудың қолданыстағы қорғанысы қажет адамдарға.",
      "ЕО аумағында уақытша сапар жасау үшін сақтандыру қажет адамдарға.",
      "Автокөлік Польша аумағы арқылы транзитпен өтетін жағдайда.",
    ],
  },
  how: {
    title: "Қалай рәсімдеуге болады",
    steps: [
      "Сайттағы нысан арқылы өтінім беріңіз.",
      "Құнын есептеу үшін автокөлік пен жүргізуші туралы деректерді жіберіңіз.",
      "Сақтандыру жарнасын өзіңізге ыңғайлы тәсілмен төлеңіз.",
      "Дайын полисті және оны тексеру жөніндегі нұсқаулықты алыңыз.",
    ],
  },
  price: {
    title: "Құны",
    text:
      "Бағасы полистің қолданылу мерзіміне және көлік құралының түріне байланысты. Шамамен алынған құнын сайттың басты бетіндегі онлайн-калькулятордан әрқашан көруге болады.",
  },
  validity: {
    title: "Қолданылу мерзімі",
    text:
      "Полистерді 30 күннен 364 күнге дейінгі мерзімге рәсімдеуге болады. Басталу күні рәсімдеу кезінде көрсетіледі, содан кейін сақтандыру қорғанысы таңдалған мерзім бойы қолданылады. Егер өтінімді толтыру кезінде қажетті мерзімді көрмесеңіз, оны түсініктеме бөлімінде көрсетіңіз.",
  },
  form: {
    title: "Өтінім нысаны",
    desc:
      "Төмендегі батырманы басыңыз — сақтандыру рәсімдеуге арналған нысаны бар басты бет ашылады.",
  },
  faq: {
    title: "Жиі қойылатын сұрақтар",
    items: [
      {
        q: "Беларусь нөмірлі автокөлікпен Беларусь–Польша шекарасынан өтуге бола ма?",
        a: "Иә, шекарадан өтуге болады. Алайда Польша ережелеріне сәйкес, Беларусь нөмірлі автокөлікте шекарадан өту кезінде көлік иесі міндетті түрде болуы тиіс. Бұл автокөлік заңды тұлғаға немесе шекарадан өту кезінде көлікте жоқ тұлғаға тиесілі болмауы керек дегенді білдіреді.",
      },
      {
        q: "Шекарадан әлі өтпеген болсам, полисті онлайн рәсімдеуге бола ма?",
        a: "Иә, полисті қажетті басталу күніне дейін алу үшін өтінімді алдын ала беруге болады.",
      },
      {
        q: "Полис тек Польша аумағында жүруге жарай ма?",
        a: "Полис Польшаға кіру үшін рәсімделеді және сақтандыру талаптарында көрсетілген елдердің аумағында қолданылуы мүмкін: Еуропалық экономикалық аймақ елдері мен Швейцария.",
      },
      {
        q: "Жүк автокөлігіне сақтандыру рәсімдеуге бола ма?",
        a: "Иә, сақтандыруды жеңіл және жүк көлігіне де рәсімдеуге болады, бірақ тек жеке тұлғаның атына, мысалы жүргізушінің атына рәсімделеді.",
      },
      {
        q: "Полис қаншалықты тез жіберіледі?",
        a: "Төлем расталғаннан кейін полис әдетте қысқа уақыт ішінде электрондық түрде жіберіледі. Нақты уақыт операторлардың жүктемесіне байланысты, орта есеппен шамамен 10 минутты құрайды.",
      },
      {
        q: "Полистің жарамдылығын қайдан тексеруге болады?",
        a: "Полисті Польшадағы UFG ресми сервисі арқылы тексеруге болады.",
      },
    ],
  },
  carousel: {
    ...
    cardTitle:
      "Беларусь автокөлігін Польшаға бару үшін сақтандыру",
    cardText: "Шарттары, мерзімдері, құны және онлайн рәсімдеу.",
    cta: "Бетті ашу",
  },
};
