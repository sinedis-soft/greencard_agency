...
export type LeadFormDictionary = {
  ...
  policy: {
    legend: string;
    countryFrom: string;
    multilateralAgreementWarning: string;
    vehicleType: string;
    engineType: string;
    vehicleVin: string;
...
const ru: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Пограничное страхование не распространяется на Ваше транспортное средство, зарегистрированное в государстве, национальное страховое бюро которого участвует в Многостороннем соглашении.",
    vehicleType: "Тип ТС",
...
const pl: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Ubezpieczenie graniczne nie obejmuje Państwa pojazdu zarejestrowanego w państwie, którego krajowe biuro ubezpieczycieli uczestniczy w Porozumieniu Wielostronnym.",
...
const en: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Frontier insurance does not apply to your vehicle because it is registered in a country whose national insurance bureau participates in the Multilateral Agreement.",
...
const be: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Памежнае страхаванне не распаўсюджваецца на Ваш транспартны сродак, зарэгістраваны ў дзяржаве, нацыянальнае страхавое бюро якой удзельнічае ў Шматбаковым пагадненні.",
    vehicleType: "Тып ТС",
...
const uz: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Chegaraviy sug‘urta milliy sug‘urta byurosi Ko‘p tomonlama bitimda ishtirok etadigan davlatda ro‘yxatdan o‘tgan transport vositangizga tatbiq etilmaydi.",
...
const ka: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "სასაზღვრო დაზღვევა არ ვრცელდება თქვენს სატრანსპორტო საშუალებაზე, რადგან ის რეგისტრირებულია სახელმწიფოში, რომლის ეროვნული სადაზღვევო ბიურო მრავალმხრივ შეთანხმებაში მონაწილეობს.",
...
const kk: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Шекаралық сақтандыру ұлттық сақтандыру бюросы Көпжақты келісімге қатысатын мемлекетте тіркелген көлік құралыңызға қолданылмайды.",
...
const tr: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Sınır sigortası, ulusal sigorta bürosu Çok Taraflı Anlaşma’ya katılan bir ülkede kayıtlı olan aracınız için geçerli değildir.",
...
const fa: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "بیمه مرزی شامل وسیله نقلیه شما نمی‌شود، زیرا این وسیله در کشوری ثبت شده است که دفتر ملی بیمه آن در توافق‌نامه چندجانبه مشارکت دارد.",
...
const hy: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Սահմանային ապահովագրությունը չի տարածվում Ձեր տրանսպորտային միջոցի վրա, քանի որ այն գրանցված է մի պետությունում, որի ազգային ապահովագրական բյուրոն մասնակցում է Բազմակողմ համաձայնագրին։",
...
const ckb: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "بیمەی سنووری بۆ ئۆتۆمبێلەکەت بەردەست نییە، چونکە لە وڵاتێک تۆمار کراوە کە نووسینگەی نیشتمانی بیمەکەی بەشداری ڕێککەوتنی فرەلایەنە دەکات.",
...
const kmr: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Sîgorteya sînorî ji bo wesayîta we derbasdar nîne, ji ber ku ew li welatekî hatiye qeydkirin ku buroya sîgorteya neteweyî ya wî beşdarî Peymana Piralî dike.",
...
const ar: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "لا يسري التأمين الحدودي على مركبتك لأنها مسجلة في دولة يشارك مكتب التأمين الوطني فيها في الاتفاقية متعددة الأطراف.",
...
const uk: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Прикордонне страхування не поширюється на Ваш транспортний засіб, зареєстрований у державі, національне страхове бюро якої бере участь у Багатосторонній угоді.",
    vehicleType: "Тип ТЗ",
...
const he: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "ביטוח גבול אינו חל על הרכב שלך, מכיוון שהוא רשום במדינה שלשכת הביטוח הלאומית שלה משתתפת בהסכם הרב־צדדי.",
...
const az: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Sərhəd sığortası milli sığorta bürosu Çoxtərəfli Sazişdə iştirak edən dövlətdə qeydiyyata alınmış nəqliyyat vasitənizə şamil edilmir.",
...
const ro: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Asigurarea de frontieră nu se aplică vehiculului dumneavoastră, deoarece acesta este înmatriculat într-un stat al cărui birou național de asigurări participă la Acordul multilateral.",
...
const sr: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Гранично осигурање се не примењује на Ваше возило јер је регистровано у држави чији национални биро осигурања учествује у Мултилатералном споразуму.",
...
const sq: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Sigurimi kufitar nuk zbatohet për automjetin tuaj, sepse ai është regjistruar në një shtet, byroja kombëtare e sigurimeve e të cilit merr pjesë në Marrëveshjen Shumëpalëshe.",
...
const mn: LeadFormDictionary = {
  ...
  policy: {
    ...
    multilateralAgreementWarning: "Хилийн даатгал нь үндэсний даатгалын товчоо нь Олон талт хэлэлцээрт оролцдог улсад бүртгэлтэй таны тээврийн хэрэгсэлд үйлчлэхгүй.",
