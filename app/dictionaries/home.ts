...
export const homeDictionary: Record<Lang, HomeDictionary> = {
  ...
  ar: {
    hero: {
      kicker: "تأمين الحدود عبر الإنترنت",
      title: "تأمين الحدود للسيارات الأجنبية في بولندا وأوروبا",
      lead:
        "للمركبات المسجّلة خارج المنطقة الاقتصادية الأوروبية عند عدم وجود بطاقة خضراء سارية. احسب التكلفة، وأرسل المستندات، واحصل على وثيقة OC Graniczne بصيغة PDF بعد التحقق من البيانات والمسار.",
      meta: [
        "للمركبات المسجّلة خارج المنطقة الاقتصادية الأوروبية",
        "وثيقة PDF عبر البريد الإلكتروني",
        "مراجعة المستندات ودول مسار الرحلة قبل الإصدار",
      ],
      ctaCalc: "احسب تكلفة التأمين",
      ctaBuy: "قدّم طلب التأمين",
    },

    calc: {
      title: "حاسبة تكلفة تأمين الحدود",
      badge: "نحو دقيقة واحدة",
      desc: "اختر نوع المركبة ومدة التأمين للاطلاع على التكلفة التقديرية.",
      termLabel: "مدة التأمين",
      ...
      vehicleOptions: [
        { value: "car", label: "سيارة ركوب" },
        { value: "van", label: "حافلة أو حافلة صغيرة" },
        { value: "truck", label: "شاحنة" },
        { value: "trailer", label: "مقطورة" },
        { value: "special", label: "مركبة خاصة" },
      ],
      button: "احسب التكلفة",
      note: "تُؤكَّد التكلفة النهائية وإمكانية الإصدار بعد مراجعة بيانات المركبة والمستندات.",
    },

    process: {
      title: "كيف تحصل على وثيقة التأمين؟",
      desc: "حساب التكلفة ← تعبئة البيانات ← مراجعة المستندات والمسار ← الدفع ← استلام الوثيقة بصيغة PDF.",
      steps: [
        {
          title: "احسب التكلفة",
          text: "اختر نوع المركبة ومدة التأمين: 30 أو 60 أو 90 أو 180 أو 364 يومًا.",
        },
        {
          title: "أدخل البيانات",
          text: "أدخل بيانات طالب التأمين والمركبة، بما في ذلك بلد التسجيل ورقم اللوحة ورقم الهيكل (VIN) وبيانات الاتصال.",
        },
        {
          title: "انتظر نتيجة المراجعة",
          text: "نتحقق من المستندات ودول مسار الرحلة ومن إمكانية إصدار وثيقة OC Graniczne وفقًا لشروط التأمين.",
        },
        {
          title: "ادفع واستلم الوثيقة",
          text: "بعد تأكيد إمكانية الإصدار والدفع، نرسل وثيقة التأمين بصيغة PDF إلى بريدك الإلكتروني.",
        },
      ],
    },
    ...
    insuranceGuide: {
      directAnswer:
        "تأمين الحدود (OC Graniczne) هو تأمين مؤقت وإلزامي للمسؤولية المدنية. قد تحتاج إليه إذا كانت مركبتك مسجّلة خارج المنطقة الاقتصادية الأوروبية وتدخل بولندا أو دولة أخرى مشمولة بالتغطية من دون بطاقة خضراء سارية ومعترف بها على كامل مسار الرحلة. لا يناسب هذا المنتج المركبات المسجّلة داخل المنطقة الاقتصادية الأوروبية، ولا يغطي الأضرار التي تلحق بمركبتك نفسها.",
      fit: {
        ...
        links: [
          ...
          { href: "/product-info", label: "معلومات المنتج" },
        ],
      },
      notFit: {
        title: "متى لا يناسبك هذا التأمين؟",
        items: [
          "إذا كانت المركبة مسجّلة في بولندا أو ليتوانيا أو لاتفيا أو ألمانيا أو أي دولة أخرى ضمن المنطقة الاقتصادية الأوروبية؛",
          "إذا كنت تريد تغطية الأضرار التي تلحق بمركبتك، لأن هذا التأمين ليس تأمينًا شاملًا أو كاسكو؛",
          "إذا كان مسار الرحلة يمر بدولة غير مشمولة بالتغطية المحددة في الوثيقة؛",
          "إذا كنت تحتاج إلى وثيقة يبدأ سريانها في تاريخ سابق؛",
          "إذا كانت الرحلة تمر عبر تركيا أو صربيا أو دولة أخرى غير مدرجة في الوثيقة، فقد تحتاج إلى بطاقة خضراء أو تأمين حدودي محلي أو منتج آخر لذلك الجزء من المسار.",
        ],
      },
      service: {
        title: "من يصدر وثيقة التأمين؟",
        text: "تُبرم وثيقة التأمين لدى TUiR WARTA S.A. بمساعدة وكيل التأمين المسجّل SINEDIS SP. Z O.O. نستقبل الطلب عبر الإنترنت، ونراجع بيانات المركبة والمستندات والمسار، ثم نرسل تعليمات الدفع ووثيقة التأمين بصيغة PDF بعد الإصدار.",
        items: [
          "نستقبل طلب التأمين عبر الإنترنت؛",
          "نراجع بيانات المركبة والمستندات المرفقة؛",
          "نتحقق مما إذا كان تأمين الحدود مناسبًا لبلد التسجيل ومسار الرحلة؛",
          "نرسل تعليمات الدفع بعد تأكيد إمكانية الإصدار؛",
          "نرسل وثيقة التأمين بصيغة PDF ونوضح كيفية التحقق منها.",
        ],
      },
      documents: {
        title: "ما البيانات والمستندات المطلوبة؟",
        text: "جهّز نسخة واضحة ومقروءة من مستند تسجيل المركبة قبل تعبئة الطلب. نستخدم البيانات الواردة فيه للتحقق من رقم اللوحة ورقم الهيكل (VIN) وبلد التسجيل ومواصفات المركبة.",
        items: [
          "شهادة تسجيل المركبة أو رخصة المركبة أو الجواز الفني، بحسب بلد التسجيل؛",
          "جواز سفر طالب التأمين أو بطاقة هويته؛",
          "رقم لوحة التسجيل ورقم الهيكل (VIN)؛",
          "ماركة المركبة وطرازها وسنة الصنع؛",
          "بلد تسجيل المركبة ونوعها؛",
          "سعة المحرك وقدرته؛",
          "تاريخ بدء التأمين والمدة المطلوبة؛",
          "البريد الإلكتروني ورقم الهاتف؛",
          "جميع دول العبور والوجهة النهائية، ولا سيما إذا كان مسار الرحلة غير معتاد.",
        ],
        link: { href: "/product-info", label: "اطّلع على معلومات المنتج" },
      },
      price: {
        title: "كم تبلغ تكلفة تأمين الحدود؟",
        text: "تعتمد التكلفة على نوع المركبة ومدة التأمين والتعرفة السارية. تعرض الحاسبة تكلفة تقديرية، بينما تُؤكَّد التكلفة النهائية وإمكانية الإصدار بعد مراجعة بيانات المركبة والمستندات.",
        items: [
          "المدد المتاحة: 30 أو 60 أو 90 أو 180 أو 364 يومًا؛",
          "تختلف التعرفة بحسب فئة المركبة؛",
          "نؤكد السعر النهائي قبل الدفع؛",
          "إذا كانت البيانات غير مكتملة، نتواصل معك قبل إصدار الوثيقة.",
        ],
      },
      timing: {
        title: "كم يستغرق إصدار الوثيقة؟",
        text: "عندما تكون البيانات والمستندات كاملة وصحيحة، يستغرق الإصدار عادةً نحو 10–20 دقيقة خلال ساعات العمل. وقد يستغرق وقتًا أطول إذا لزم التحقق من المسار أو الحصول على موافقة أو تصحيح البيانات. ننصح بتقديم الطلب قبل الرحلة بيوم أو يومي عمل. لا يمكن إصدار الوثيقة بأثر رجعي.",
      },
      notCovered: {
        title: "أين لا تسري وثيقة OC Graniczne؟",
        text: "تسري الوثيقة فقط في الدول المدرجة فيها ضمن نطاق التغطية. إذا كان مسار الرحلة يمر عبر تركيا أو صربيا أو الجبل الأسود أو مقدونيا الشمالية أو البوسنة والهرسك أو أي دولة أخرى غير مذكورة في الوثيقة، فلا تغطي وثيقة OC Graniczne ذلك الجزء من الرحلة. تحقّق من كامل المسار قبل الدفع وقبل المغادرة.",
        link: { href: "#coverage", label: "عرض دول التغطية" },
      },
      checkPolicy: {
        title: "ما الذي يجب التحقق منه في الوثيقة قبل السفر؟",
        text: "لا تستخدم الوثيقة إذا وجدت فيها خطأ. يجب أن تتطابق البيانات الواردة في ملف PDF مع مستند تسجيل المركبة ومع تفاصيل الرحلة التي قدّمتها.",
        items: [
          "رقم لوحة التسجيل؛",
          "رقم الهيكل (VIN)؛",
          "بلد تسجيل المركبة؛",
          "ماركة المركبة وطرازها؛",
          "تاريخ ووقت بدء التغطية وانتهائها؛",
          "نوع المركبة؛",
          "الدول المشمولة بالتغطية؛",
          "بيانات طالب التأمين.",
        ],
        link: { href: "#verify", label: "كيفية التحقق من الوثيقة" },
      },
    },

    why: {
      title: "ماذا نقدم لك؟",
      desc: "مراجعة عملية قبل الإصدار للتأكد من ملاءمة الوثيقة للمركبة والمسار المعلن.",
      items: [
        {
          title: "طلب كامل عبر الإنترنت",
          text: "ترسل بيانات طالب التأمين والمركبة والمستندات من دون زيارة المكتب.",
        },
        {
          title: "مراجعة بيانات المركبة",
          text: "نطابق رقم الهيكل (VIN) ورقم اللوحة وبلد التسجيل ونوع المركبة ومدة التأمين مع المستندات.",
        },
        {
          title: "التحقق من المسار",
          text: "نتحقق من ملاءمة تأمين الحدود لبلد تسجيل المركبة ودول العبور والوجهة.",
        },
        {
          title: "وثيقة PDF ومساعدة في التحقق",
          text: "بعد الدفع والإصدار، نرسل الوثيقة إلى بريدك الإلكتروني ونوضح لك كيفية التحقق من سريانها ونطاقها الإقليمي.",
        },
      ],
    },

    form: {
      title: "طلب تأمين الحدود",
      desc: "أدخل البيانات وأرفق المستندات. نراجع الطلب، ونؤكد إمكانية الإصدار والتكلفة، ثم نرسل إليك تعليمات الدفع.",
    },

    faq: {
      title: "الأسئلة الشائعة",
      desc: "إجابات واضحة عن إصدار تأمين الحدود وتكلفته وتغطيته.",
      items: [
        {
          q: "هل يمكن إصدار تأمين الحدود عبر الإنترنت؟",
          a: "نعم. يمكنك تقديم الطلب والمستندات عبر الإنترنت. بعد مراجعة البيانات وتأكيد إمكانية الإصدار والدفع، نرسل وثيقة التأمين بصيغة PDF إلى بريدك الإلكتروني.",
        },
        {
          q: "لمن يناسب تأمين الحدود؟",
          a: "قد يناسب المركبات المسجّلة خارج المنطقة الاقتصادية الأوروبية عند دخول بولندا أو دولة أخرى مشمولة بالتغطية من دون بطاقة خضراء سارية ومعترف بها على كامل مسار الرحلة.",
        },
        {
          q: "هل يمكن إصدار الوثيقة لمركبة مسجّلة في بولندا أو دولة أخرى ضمن المنطقة الاقتصادية الأوروبية؟",
          a: "لا. هذا المنتج غير مخصص للمركبات المسجّلة في بولندا أو ليتوانيا أو لاتفيا أو ألمانيا أو أي دولة أخرى ضمن المنطقة الاقتصادية الأوروبية.",
        },
        {
          q: "في أي دول تسري الوثيقة؟",
          a: "تسري الوثيقة فقط في الدول المدرجة فيها ضمن نطاق التغطية. قبل السفر، تحقّق من أن جميع دول العبور والوجهة النهائية مذكورة في الوثيقة.",
        },
        {
          q: "هل تسري الوثيقة في تركيا أو صربيا؟",
          a: "لا تسري في تركيا أو صربيا ما لم تكونا مدرجتين صراحةً في الوثيقة ضمن نطاق التغطية. وقد تحتاج لذلك الجزء من الرحلة إلى بطاقة خضراء أو تأمين حدودي محلي أو منتج آخر.",
        },
        {
          q: "هل يمكن إصدار الوثيقة في يوم السفر؟",
          a: "قد يكون ذلك ممكنًا خلال ساعات العمل إذا كانت جميع البيانات والمستندات كاملة وصحيحة. ومع ذلك، ننصح بتقديم الطلب قبل الرحلة بيوم أو يومي عمل، لأن بعض الحالات تتطلب تحققًا إضافيًا أو تصحيحًا للبيانات.",
        },
        {
          q: "هل يمكن إصدار تأمين الحدود بأثر رجعي؟",
          a: "لا. لا يمكن أن يبدأ التأمين في تاريخ أو وقت يسبق إبرام العقد. يسري التأمين فقط خلال الفترة المحددة في الوثيقة.",
        },
        {
          q: "ما المستندات المطلوبة؟",
          a: "نحتاج عادةً إلى مستند تسجيل المركبة، وجواز سفر طالب التأمين أو بطاقة هويته، ورقم اللوحة، ورقم الهيكل (VIN)، وماركة المركبة وطرازها وسنة صنعها، وبلد التسجيل، ونوع المركبة، وتاريخ بدء التأمين ومدته، والبريد الإلكتروني ورقم الهاتف، إضافةً إلى كامل مسار الرحلة.",
        },
        {
          q: "ما البيانات التي تتضمنها وثيقة التأمين؟",
          a: "تتضمن الوثيقة بيانات المركبة وطالب التأمين، وبلد التسجيل، ونوع المركبة، وفترة السريان، والدول المشمولة بالتغطية، وبيانات شركة التأمين.",
        },
        {
          q: "ماذا أفعل إذا وجدت خطأ في الوثيقة؟",
          a: "لا تستخدم وثيقة تتضمن بيانات غير صحيحة. تواصل معنا قبل السفر للتحقق من إمكانية التصحيح. وقد تتطلب بعض الأخطاء إلغاء الوثيقة وإصدار وثيقة جديدة وفقًا لشروط شركة التأمين.",
        },
        {
          q: "هل سأحصل على الوثيقة بصيغة PDF؟",
          a: "نعم. بعد مراجعة البيانات وتأكيد إمكانية الإصدار والدفع، نرسل وثيقة التأمين بصيغة PDF إلى البريد الإلكتروني المذكور في الطلب.",
        },
        {
          q: "هل يمكن الدفع ببطاقة مصرفية؟",
          a: "لا يتوفر الدفع بالبطاقة المصرفية حاليًا. يمكنك الدفع عن طريق SWIFT أو SEPA أو التحويل من بطاقة إلى بطاقة (P2P) أو BLIK. نرسل تعليمات الدفع بعد إعداد الوثيقة.",
        },
        {
          q: "هل تأمين الحدود هو نفسه البطاقة الخضراء؟",
          a: "لا. تأمين الحدود (OC Graniczne) والبطاقة الخضراء منتجان مختلفان. تصدر البطاقة الخضراء عادةً في بلد تسجيل المركبة قبل السفر، أما تأمين الحدود فهو حل مؤقت للمركبة الأجنبية عندما لا توجد بطاقة خضراء سارية ومعترف بها على المسار.",
        },
        {
          q: "ما نوع هذا التأمين؟",
          a: "هو تأمين إلزامي للمسؤولية المدنية لمالك المركبة أو مستخدمها. يغطي مسؤوليتك تجاه الغير خلال فترة السريان وفي الدول المدرجة في الوثيقة، ولا يغطي الأضرار التي تلحق بمركبتك نفسها.",
        },
        {
          q: "ماذا يغطي التأمين؟",
          a: `يغطي التأمين، ضمن الشروط والحدود القانونية:
            • الأضرار الجسدية التي تلحق بالغير؛
            • الأضرار المادية التي تلحق بممتلكات الغير.

            الحد الأدنى لمبالغ الضمان:
            • 29 876 400 PLN للأضرار الجسدية؛
            • 6 021 600 PLN للأضرار المادية.`,
        },
        {
          q: "ما الذي لا يغطيه التأمين؟",
          a: `لا يغطي، من بين أمور أخرى:
            • الأضرار التي تلحق بمركبة المؤمن له نفسها؛
            • الأضرار التي تلحق بمالك المركبة بصفته مالكًا للممتلكات المتضررة؛
            • الأضرار البيئية والحالات الأخرى المستثناة بموجب القانون وشروط التأمين؛
            • الدراجات ووسائل النقل غير الميكانيكية.`,
        },
        {
          q: "متى يحق لشركة التأمين الرجوع على السائق؟",
          a: `قد تطالب شركة التأمين السائق برد التعويض المدفوع إذا كان السائق:
            • تسبب في الضرر عمدًا؛
            • قاد تحت تأثير الكحول أو المخدرات؛
            • قاد من دون رخصة قيادة سارية؛
            • فرّ من موقع الحادث؛
            • استخدم مركبة حصل عليها عن طريق جريمة.`,
        },
        {
          q: "متى يبدأ التأمين ومتى ينتهي؟",
          a: `يبدأ التأمين في التاريخ والوقت المحددين في الوثيقة، ولا يمكن أن يبدأ قبل إبرام العقد.

            المدد المتاحة: 30 أو 60 أو 90 أو 180 أو 364 يومًا.

            ينتهي التأمين عند انتهاء المدة المحددة في الوثيقة، أو عند شطب المركبة، أو في الحالات الأخرى المنصوص عليها في العقد والقانون.`,
        },
      ],
    },

    verify: {
      title: "التحقق من صلاحية وثيقة التأمين",
      lead:
        "استخدم قاعدة البيانات الرسمية للدولة التي أصدرت فيها الوثيقة. يمكن التحقق من وثيقة WARTA البولندية في قاعدة UFG. أما الوثائق الصادرة في لاتفيا أو ليتوانيا فتُفحص في قواعد البيانات الرسمية الخاصة بهاتين الدولتين.",
      items: [
        {
          code: "PL",
          country: "بولندا",
          org: "UFG — Ubezpieczeniowy Fundusz Gwarancyjny",
          desc: "التحقق من سريان تأمين المسؤولية المدنية البولندي باستخدام رقم لوحة التسجيل أو رقم الهيكل (VIN) في قاعدة UFG الرسمية.",
          cta: "التحقق في قاعدة UFG",
          href: "https://www.ufg.pl/",
        },
        {
          code: "LV",
          country: "لاتفيا",
          org: "LTAB — Latvijas Transportlīdzekļu apdrošinātāju birojs",
          desc: "التحقق من سريان تأمين OCTA للمركبات المؤمن عليها في لاتفيا عبر قاعدة LTAB الرسمية.",
          cta: "التحقق في قاعدة LTAB",
          href: "https://www.ltab.lv/",
        },
        {
          code: "LT",
          country: "ليتوانيا",
          org: "CAB — Motor Insurers’ Bureau of Lithuania",
          desc: "التحقق من سريان التأمين الإلزامي للمسؤولية المدنية للمركبات المؤمن عليها في ليتوانيا.",
          cta: "التحقق في قاعدة CAB",
          href: "https://www.cab.lt/",
        },
      ],
    },
    ...
    businessHours: {
      openLabel: "نحن متاحون الآن",
      closedLabel: "خارج ساعات العمل",

      openDetails: "نستقبل الطلبات حتى الساعة {time} حسب توقيتك المحلي",

      closingSoonHoursMinutes:
        "تنتهي ساعات العمل بعد {hours} ساعة و{minutes} دقيقة",
      closingSoonHours: "تنتهي ساعات العمل بعد {hours} ساعة",
      closingSoonMinutes: "تنتهي ساعات العمل بعد {minutes} دقيقة",
      closingSoonExtra:
        "يمكنك إرسال الطلب الآن. وإذا تطلبت المراجعة وقتًا إضافيًا، فسنواصل معالجته في يوم العمل التالي.",

      closedBeforeOpeningToday:
        "نبدأ العمل اليوم في الساعة {time} حسب توقيتك المحلي",
      closedUntilTomorrow:
        "نبدأ العمل غدًا في الساعة {time} حسب توقيتك المحلي",
      closedUntilMonday:
        "نبدأ العمل يوم الاثنين في الساعة {time} حسب توقيتك المحلي",
      closedExtra:
        "يمكنك إرسال الطلب الآن، وسنراجعه خلال ساعات العمل.",

      timezoneNote:
        "تُعرض الأوقات وفق المنطقة الزمنية المضبوطة على جهازك: {timezone}.",
    },
  },
  uk: {
    hero: {
